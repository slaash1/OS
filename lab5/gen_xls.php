...
ob_end_clean();
$title = 'Таблица';
 $array = array("№ п/п", "Название ОС", "Цифровой магазин", "Тип оборудования", "Разрядность", "Разработчик",  "Количество пользователей", "Цифровой ключ", "Дата приобретения", "Дата окончания", "url магазина");
$xls = new PHPExcel();
$xls->getProperties()->setTitle("Операционные системы");
$xls->getProperties()->setSubject("lab5");
$xls->getProperties()->setCreator("Айдар Гиниятуллин");
$xls->getProperties()->setCompany("USATU");
$xls->getProperties()->setCategory("Операционные системы");
$xls->getProperties()->setKeywords("Операционные системы");
...
header("Content-Disposition: attachment; filename=OS.xls");
